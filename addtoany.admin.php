...
function _a2a_position_in_content( $options, $option_box = false ) {
    ...
    if ( $option_box ) {
        ...
        return $html;check_admin_referer( 'add-to-any-update-options' );
    }
}
...
function A2A_SHARE_SAVE_options_page() {
    ...
    if ( isset( $_POST['Submit'] ) ) {
        ...
        if( is_xtec_super_admin() ){
            ...
            $existing_options['display_in_posts_on_front_page'] = -1;
            }
            if (!isset($options['display_in_posts_on_archive_pages'])) {
                $existing_options['display_in_posts_on_archive_pages'] = -1;
            }
        }
        if (!isset($existing_options['display_in_feed'])) {
            $existing_options['display_in_feed'] = -1;
        }
        if (!isset($existing_options['display_in_excerpts'])) {
            $existing_options['display_in_excerpts'] = -1;
        }
        if (!isset($existing_options['display_in_pages'])) {
            $existing_options['display_in_pages'] = -1;
        }
        //************ FI
                ...
                <?php if ( 'default' == $current_screen ) : ?>
                    ...
                    <tr valign="top">
                        ...
                        <td><fieldset>
                                ...
                                <?php
                                // XTEC ************ MODIFICAT - Hidde other info plugin to all users but xtecadmin
                                // 2020.02.14 @nacho
                                if (is_xtec_super_admin()) {
                                ?>
                                    <!--
                    ...
                    <tr valign="top">
                        ...
                        <!--
                        // XTEC ************ MODIFICAT - rename class to addtoany_extra_section_universal for load this button
                        // 2020.02.14 @nacho
                        -->
                        <td><fieldset id="addtoany_extra_section_universal_button" class="addtoany_extra_section_universal">
                        <!--//************ ORIGINAL
                    ...
                    <?php
                    // XTEC ************ MODIFICAT - Hidde sharing header to all users but xtecadmin
                    // 2020.02.14 @nacho
                    if (is_xtec_super_admin()) {
                    ?>
                    <tr valign="top">
                        ...
                        <td><fieldset id="addtoany_extra_section_sharing_header" class="addtoany_extra_section<?php if ( ! empty( $options['header'] ) ) echo ' addtoany_show_extra'; ?>" role="region">
                                <label>
                                    ...
                                    // 2020.02.14 @nacho
                                    -->
                                    <input name="A2A_SHARE_SAVE_header" type="text" class="code" placeholder="<?php esc_attr_e( _e('Share this:', "add-to-any" ) ); ?>" size="50" value="<?php if ( isset( $options['header'] ) ) echo esc_attr( $options['header'] ); ?>" />
                                    <!--
                                    //************ ORIGINAL
...
<!--
// XTEC ************ MODIFICAT - Hide other display options
// 2015.09.23 @nacho
                                <br/>
                                <label>
...
<!--
// XTEC ************ MODIFICAT - Added language translation for menu options
// 2015.09.23 @nacho
                    <tr valign="top">
...
-->
                    <tr valign="top">
                        <?php
                        // XTEC ************ MODIFICAT - Hide additional javascript to all users but xtecadmin
                        // 2020.02.14 @nacho
                        if (is_xtec_super_admin()) {
                        ?>
                        <!--
                    ...
                    <tr valign="top">
                        <?php
                        // XTEC ************ MODIFICAT - Hide additional css to all users but xtecadmin
                        // 2020.02.14 @nacho
                        if (is_xtec_super_admin()) {
                        ?>
                        <!--
                    ...
                    <?php
                    // XTEC ************ MODIFICAT - Hide advanced options to all users but xtecadmin
                    // 2020.02.14 @nacho
                    if (is_xtec_super_admin()) {
                    ?>
                    <tr valign="top">
        ...
        <?php
        // XTEC ************ MODIFICAT - Hide Like plugin to all users but xtecadmin
        // 2020.02.14 @nacho
        if (is_xtec_super_admin()) {
        ?>
    ...
    if ( isset( $_GET['page'] ) && $_GET['page'] == 'addtoany' ) {
        ...
        <script>
            jQuery(document).ready(function(){
                ...
                // XTEC ************ MODIFICAT - add class addtoany_extra_section_universal
                // 2020.02.14 @nacho
                jQuery('.addtoany_extra_section, .addtoany_extra_section_universal:not(.addtoany_show_extra, :has(.addtoany_extra_element:visible), :has(textarea:not(:empty)))').hide()
                    .each(addtoany_insert_show_button);
                /*
                //************ ORIGINAL
                ...
                */
                ...
                // XTEC ************ MODIFICAT - Handle click on 'show section' button
                // 2020.02.14 @nacho
                jQuery('.addtoany_extra_section, .addtoany_extra_section_universal').next('fieldset').find('.addtoany_show_more_button').click(function(e) {
                ...
                */
                ...
                // XTEC ************ MODIFICAT - Add margin-top to 'show section' buttons if section is visible
                // 2020.02.14 @nacho
                jQuery('.addtoany_extra_section:visible, .addtoany_extra_section_universal:visible').next('fieldset').find('.addtoany_show_more_button').css('margin-top', '10px');
                /*
                //************ ORIGINAL
                ...
                */
                ...
                <?php
                // XTEC ************ AFEGIT - Hide buttons with class addtoany_extra_section to all users but xtecadmin
                // 2020.02.14 @nacho
                if (!is_xtec_super_admin()) {
                    ?>
                    jQuery('.addtoany_extra_section').next('fieldset').find('.addtoany_show_more_button').hide();
                    <?php
                }
                //************ FI
                ?>
        ...
        <style>
            ...
            /* XTEC ************ MODIFICAT - added addtoany_extra_section_universal class
            // 2020.02.14 @nacho
            */
            .addtoany_extra_section .addtoany_extra_section_universal {
                outline: 0;
            }
            /*
            //************ ORIGINAL
...
delete_option( 'addtoany_options' );        </style>
        <?php
...
add_action( 'admin_enqueue_scripts', 'addtoany_admin_scripts' );wp_enqueue_script( 'wp-pointer' );
